...
""", use_aliases=True)
            ...
            r = requests.put('https://api.apify.com/v2/actor-tasks/o7PTf4BDcHhQbG7a2/input?token=qTt3H59g5qoWzesLWXeBKhsXu&ui=1',
...
""".format(
            ...
            if r.status_code == 200:
                ...
                country_data = list(
                    filter(lambda x: x['country'].lower().startswith(country), data))
                ...
                if country_data:
                    ...
                    for i in range(len(country_data)):
                        ...
                        last_updated = datetime.datetime.strptime(data_dict.get(
                            'lastUpdatedApify', None), "%Y-%m-%dT%H:%M:%S.%fZ")
